    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4 mx-11">
        <div class="flex items-center justify-between">
            ...
            <div class="lg:ml-40 ml-10 space-x-8">
                ...
                @if($isOpen)
                    @include('livewire.departamento.departamento-create')
                @endif
            </div>
        ...
        <div class="shadow overflow-x-auto border-b border-gray-700 sm:rounded-lg mt-5">
            <table class="w-full divide-y divide-gray-200 table-auto">
                ...
                <tbody class="divide-y divide-indigo-900 capitalize">
                    ...
                    <tr class="text-sm text-center font-medium text-gray-900 capitalize" wire:key="departamento-{{$item->id}}">
                        <td class="px-6 py-4">
                      ...
                      <td class="px-6 py-4">
                        <div class="inline-flex italic items-center px-3 py-1 text-blue-500 rounded-full gap-x-2 bg-vtext-blue-100">
        ...
        Swal.fire({
          ...
          confirmButtonText: 'Yes, delete it!'
            ...
            if (result.isConfirmed) {
                //console.log(id);
                //Livewire.emitTo('departamento-main','delete',id);
                Livewire.dispatch('delItem', { departamento: id })
                Swal.fire(
                    'Deleted!',
