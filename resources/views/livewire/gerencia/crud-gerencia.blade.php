    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4 mx-11">
        <div class="flex items-center justify-between">
            ...
            <div class="lg:ml-40 ml-10 space-x-8">
                ...
                @if($isOpen)
                    @include('livewire.gerencia.gerencia-create')
                @endif
            </div>
        ...
        <div class="shadow overflow-x-auto border-b border-gray-700 sm:rounded-lg mt-5">
            <table class="w-full divide-y divide-gray-200 table-auto">
                ...
                <tr class="text-sm font-medium text-gray-900 capitalize text-center" wire:key="gerencia-{{$item->id}}">
                    <td class="px-6 py-4">
                  ...
                  <td class="px-6 py-4">
                    <div class="inline-flex italic items-center px-3 py-1 text-red-500 rounded-full gap-x-2 bg-red-100">
        ...
        Swal.fire({
          ...
          confirmButtonText: 'Yes, delete it!'
            ...
            if (result.isConfirmed) {
                //console.log(id);
                //Livewire.emitTo('gerencia-main','delete',id);
                Livewire.dispatch('delItem', { gerencia: id })
                Swal.fire(
                    'Deleted!',
