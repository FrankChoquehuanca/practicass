    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4 mx-11">
        ...
        <div class="shadow overflow-x-auto border-b border-gray-700 sm:rounded-lg mt-5">
            <table class="w-full divide-y divide-gray-200 table-auto">
                ...
                <tr class="text-sm text-center font-medium text-gray-900 capitalize" wire:key="unidad-{{$item->id}}">
                    <td class="px-6 py-4">
                  ...
                  <td class="px-6 py-4">
                    <div class="inline-flex italic items-center px-3 py-1 text-green-500 rounded-full gap-x-2 bg-vtext-green-100">
        ...
        Swal.fire({
          ...
          confirmButtonText: 'Yes, delete it!'
            ...
            if (result.isConfirmed) {
                //console.log(id);
                //Livewire.emitTo('unidad-main','delete',id);
                Livewire.dispatch('delItem', { unidad: id })
                Swal.fire(
                    'Deleted!',
